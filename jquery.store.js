(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.currency = "Shs"; // HTML entity of the currency to be displayed in the layout
			this.currencyString = "Shs"; // Currency symbol as textual string
			this.paypalCurrency = "SHS"; // PayPal's currency code
